...
message = visual.TextStim(win, text ='Instructions: Please click the f key as fast as possible if you see a circle and the j key as fast as possible if you see a square. However, on some trials, a red dot will appear in the center of the screen after a brief delay. If you see the red dot, do NOT press any key.',
height = 0.07)
message.draw(win=None)
...
def actual_right_go_signal():
    ...
    visual.rect.Rect(win, width = 0.022, height= 0.022, lineColor = (255,255,255), pos = (0.25, 0.25), fillColor = True).draw(win=None)
    visual.rect.Rect(win, width = 0.022, height= 0.022, lineColor = (255,255,255), pos = (-0.25, 0.25), fillColor = True).draw(win=None)
    visual.rect.Rect(win, width = 0.022, height= 0.022, lineColor = (255,255,255), pos = (0.25, -0.25), fillColor = True).draw(win=None)
    visual.rect.Rect(win, width = 0.022, height= 0.022, lineColor = (255,255,255), pos = (-0.25, -0.25), fillColor = True).draw(win=None)
    win.flip()
...
message = visual.TextStim(win, text="Now, let's move on to the experiment. Remember: click the 'f' key if you see a circle and the 'j' key if you see a square. Make your responses as fast as possible. However, if you see the red dot, do not press either key." )
message.draw(win=None)
message.autoDraw = False  # Automatically draw every frame
win.flip()
core.wait(5.0)
